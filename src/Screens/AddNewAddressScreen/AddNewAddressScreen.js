...
const AddNewAddressScreen = ({navigation, route}) => {
  ...
  const [city, setCity] = useState(route.params.type==='EDIT'? route.params.data.district : '');
  const [selectedIndex, setSelectedIndex] = useState(
    route.params.type==='EDIT'? route.params.data.type === 'HOME' ? 0 : 1 : 0,
  );
  const [isDefault, setIsDefault] = useState(route.params.type==='EDIT' ?route.params.data.default : false);
          ...
          <View
            ...
            <View>
              <View
                ...
                <CheckBox
                  checked={isDefault}
                  disabled={route.params.type==='EDIT' ?route.params.data.default : false}
